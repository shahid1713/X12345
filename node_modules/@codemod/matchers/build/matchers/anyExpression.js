...
exports.anyExpression = exports.AnyExpressionMatcher = void 0;
const t = __importStar(require("@babel/types"));
const Matcher_1 = require("./Matcher");
class AnyExpressionMatcher extends Matcher_1.Matcher {
    matchValue(value) {
        return t.isNode(value) && t.isExpression(value);
    }
}
exports.AnyExpressionMatcher = AnyExpressionMatcher;
